...
public class MainGUI implements IGUI {
    ...
    private JTextField _calibrationEntry;
    private JTextField _ampGainEntry;
    ...
    private LibcbwBoard.USB_1608FS _board;
    ...
    private void initialize() {
        ...
        try {
            ...
            for(int i = 0; i < daqArray.length; i++) {
                if(daqArray[i].ProductID == 125 || daqArray[i].ProductID == 234) {
                    _board = daqArray[i].createDaqDevice(LibcbwBoard.USB_1608FS::new);
                    _board.digitalOut(AAARunner.MAGNET_OUT, true);
                }
            }
        } catch(Exception e) {
            // TODO: handle exception
        }
        _runner = new AAARunner(_board, this);
        ...
        _calibrationEntry = new JTextField();
        calibrateTab.add(_calibrationEntry, "cell 1 0,growx");
        _calibrationEntry.setColumns(10);

        JLabel lblAmpGain = new JLabel("Amp gain");
        calibrateTab.add(lblAmpGain, "cell 0 1,alignx trailing");

        _ampGainEntry = new JTextField();
        calibrateTab.add(_ampGainEntry, "cell 1 1,growx");
        _ampGainEntry.setColumns(10);
        ...
        selectTestPanel
                .setBorder(new TitledBorder(null, "Select test", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        panel_11.setBorder(
                new TitledBorder(null, "Results (3 test average)", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    @Override
    public void makeGraphs(double[] acceleration, double[] velocity, double[] disp, int scale) {
